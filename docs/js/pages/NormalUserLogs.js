// 普通用户操作日志页面
const NormalUserLogs = () => {
    console.log('NormalUserLogs component is rendering...');
    ...
    const [logData, setLogData] = React.useState([
        ...
        },
        {
            ...
            operationType: '下架',
            operationResult: '成功',
            operationTime: '2024-01-15 12:30:45'
        },
        {
            id: 'nu_005',
            username: '钱七',
            ...
            operationType: '私信',
            operationResult: '成功',
            operationTime: '2024-01-15 13:45:20'
        }
    ]);
    ...
    const handleExport = () => {
        ...
        setTimeout(() => {
            message.success(`已导出 ${filteredData.length} 条普通用户操作日志数据`);
        }, 2000);
    };
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            ...
            }, '记录普通用户在平台上的所有关键操作，包括登录、评论、发布、下架、私信、注销等')
        ]),
...
// 暴露到全局作用域
window.NormalUserLogs = NormalUserLogs;
