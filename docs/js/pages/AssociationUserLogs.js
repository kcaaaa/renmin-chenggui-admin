// 协会用户操作日志页面
const AssociationUserLogs = () => {
    console.log('AssociationUserLogs component is rendering...');
    ...
    const [logData, setLogData] = React.useState([
        ...
        },
        {
            ...
            operationType: '下架',
            operationResult: '成功',
            operationTime: '2024-01-15 11:30:45'
        },
        {
            id: 'au_005',
            username: '协会审核员',
            ...
            operationType: '私信',
            operationResult: '成功',
            operationTime: '2024-01-15 12:45:20'
        }
    ]);
    ...
    const handleExport = () => {
        ...
        setTimeout(() => {
            message.success(`已导出 ${filteredData.length} 条协会用户操作日志数据`);
        }, 2000);
    };
    ...
    return React.createElement('div', {
        ...
        React.createElement('div', {
            ...
            }, '记录协会用户在平台上的所有关键操作，包括登录、发布、下架、评论、私信、注销等')
        ]),
...
// 暴露到全局作用域
window.AssociationUserLogs = AssociationUserLogs;
